...

{
    ...
    {
        # this issue was reported as https://svn.boost.org/trac/boost/ticket/8701
        ...
        # $polygon->scale(0.99);  # uncommenting this line makes it work
        if (0) {
            require "Slic3r/SVG.pm";
            Slic3r::SVG::output("poly.svg",
                polygons => [$polygon],
                polylines => [$polyline],
            );
        }
